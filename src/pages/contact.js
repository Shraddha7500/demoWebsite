    ...
    <>
     ...
     <div className='container'>  
      ...
      <div className='contact-info'>
          <div>
            <h4> Address: <span className='address'>McDonald, New Delhi</span>  </h4>
          </div>
          <div>
            <h4> Phone: <span>+91 8888888888</span> </h4>
          </div>
          <div>
            <h4> Email: <span>construct@info.com </span></h4>
          </div>
          <div>
            <h4> Website: <span>construct.com</span> </h4>
          </div>
      </div>

      <div className='row contact-row'>
        <div className='col-md-6 col-12'>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2254.771734925437!2d72.95381629173572!3d19.203978296008938!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b90c5b60c117%3A0x66e8f733cea69d0!2sDMart%20Corporate%20Office!5e0!3m2!1sen!2sin!4v1700906645219!5m2!1sen!2sin" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title='whatever'></iframe>
        </div>
        <div className='col-md-6 col-12'>
